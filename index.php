<?php 
	...
	// Check if valid page number else set to 1
			...
			<div class="row mt50">
				...
				<?php $movie = $movies[$x];?>
					<div class="col-sm-4 movie" > 
						...
						<p class="release"><?php echo "Release date: " . $movie->release_date ?></p>
						...
						<div class="movie-title-container">
							<h5 class="movie-title openMovie" data-movie_id="<?php echo $movie->id ?>"><?php echo $movie->title ?></h5>
							<div class="overview"><div data-container="body" data-toggle="popover" data-placement="auto" data-trigger="hover" data-content="<?php echo $movie->overview ?>">i</div></div>
						</div>
					</div>
				<?php } ?>
			</div>
					...
					<nav>
						<ul class="pagination justify-content-center">
							<?php 
								...
								if($page > 1){
									echo "<li class=\"page-item\"><a class=\"page-link\" aria-label=\"Previous\" href=\"/?page=" . ($page - 1) . "  \"> <span aria-hidden=\"true\">&laquo;</span><span class=\"sr-only\">Previous</span> </a></li>";
								}
								...
								for($x = 1; $x < $total_pages; $x++){
									...
									echo "<li class=\"page-item $active\"><a class=\"page-link\" href=\"/?page=$x  \">". $x . "</a></li>";
								}
								
								if($total_pages > $page){
									echo "<li class=\"page-item\"><a class=\"page-link\" aria-label=\"Next\" href=\"/?page=" . ($page + 1) . "  \"> <span aria-hidden=\"true\">&raquo;</span><span class=\"sr-only\">Next</span> </a></li>";
								}
							?>
					  </ul>
					</nav>
